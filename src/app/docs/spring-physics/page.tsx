        ...
        >
          <div className="flex items-center justify-between mb-2">
            <div>
              ...
              <span className="text-xs text-neutral-500 ml-2">{preset.desc}</span>
            </div>
          ...
          <div className="space-y-4">
            <div className="p-4 rounded-lg bg-neutral-50 dark:bg-neutral-900/50 border border-neutral-200/40 dark:border-neutral-800/40">
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="text-xs text-neutral-500">default: 100</span>
              </div>
              ...
              <p className="text-xs text-neutral-500 mt-1">Low (50-150): Lazy, floaty. High (400-1000): Snappy, immediate.</p>
            </div>

            <div className="p-4 rounded-lg bg-neutral-50 dark:bg-neutral-900/50 border border-neutral-200/40 dark:border-neutral-800/40">
              <div className="flex items-center gap-2 mb-1">
                <code className="text-sm font-mono font-bold text-neutral-900 dark:text-white">damping</code>
                <span className="text-xs text-neutral-500">default: 10</span>
              </div>
              ...
              <p className="text-xs text-neutral-500 mt-1">Low (5-15): Bouncy, playful. High (25-50): Smooth, controlled.</p>
            </div>

            <div className="p-4 rounded-lg bg-neutral-50 dark:bg-neutral-900/50 border border-neutral-200/40 dark:border-neutral-800/40">
              <div className="flex items-center gap-2 mb-1">
                <code className="text-sm font-mono font-bold text-neutral-900 dark:text-white">mass</code>
                <span className="text-xs text-neutral-500">default: 1</span>
              </div>
              <p className="text-sm">How &quot;heavy&quot; the animated element feels. Higher mass = more momentum, slower to start and stop.</p>
              <p className="text-xs text-neutral-500 mt-1">Light (0.1-0.5): Quick, responsive. Heavy (2-5): Weighty, deliberate.</p>
            </div>
          </div>
        </section>
