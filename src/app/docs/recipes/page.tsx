    ...
    <div className="py-12 px-8">
      <div className="mb-12 max-w-2xl">
        ...
        <p className="text-sm text-neutral-500">
          {recipes.length} recipes · Copy the pattern, customize the physics
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {recipes.map((recipe) => (
          <Link
            ...
            className="group block p-6 bg-neutral-50 dark:bg-neutral-900/50 border border-neutral-200/40 dark:border-neutral-800/40 rounded-xl hover:border-neutral-300 dark:hover:border-neutral-700 transition-colors"
          >
